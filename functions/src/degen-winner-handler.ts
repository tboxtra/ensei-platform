...
import { calculateDegenPayouts, validateDegenPayouts } from '../../shared/degen-calculator';
...
export const onDegenWinnersChosen = functions.firestore
    ...
    .onCreate(async (snap, context) => {
        ...
        try {
            ...
            const degenResult = calculateDegenPayouts(missionId, winners, missionData);

            // Validate the calculation
            if (!validateDegenPayouts(degenResult)) {
            ...
            const userStatsUpdates = new Map<string, { totalEarned: number; tasksDone: number }>();
 ...
 */
export const onDegenMissionCompleted = functions.firestore
