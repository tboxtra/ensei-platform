...
app.get('/v1/missions/:missionId/taskCompletions', verifyFirebaseToken, async (req, res) => {
    try {
...
app.get('/v1/missions/:missionId/taskCompletions/count', verifyFirebaseToken, async (req, res) => {
    try {
        const { missionId } = req.params;
        const userId = req.user.uid;
        // Check if user is the mission creator
