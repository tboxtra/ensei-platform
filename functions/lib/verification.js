...
const linkXAccount = async (req, res) => {
    try {
        ...
        await db
            ...
            .collection('linkedAccounts')
            .doc(xAccount.id)
            .set(Object.assign(Object.assign({}, xAccount), { platform: 'x', createdAt: new Date(), updatedAt: new Date() }));
        const response = {
            success: true,
            account: xAccount
        };
...
const submitVerification = async (req, res) => {
    try {
        ...
        await db
            ...
            .doc(submission.id)
            .set(Object.assign(Object.assign({}, submission), { createdAt: submission.createdAt, expiresAt: submission.expiresAt }));
