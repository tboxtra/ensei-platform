...
export type TaskType = 'like' | 'retweet' | 'comment' | 'quote' | 'meme' | 'thread' | 'article' | 'videoreview' | 'pfp' | 'name_bio_keywords' | 'pinned_tweet' | 'poll' | 'spaces' | 'community_raid' | 'follow' | 'story_repost' | 'feed_post' | 'reel' | 'carousel' | 'hashtag_in_bio' | 'story_highlight' | 'repost_duet' | 'skit' | 'challenge' | 'product_review' | 'status_style' | 'hashtag_in_bio' | 'pinned_branded_video' | 'share_post' | 'group_post' | 'video' | 'meme_flyer' | 'bio_keyword' | 'pinned_post' | 'status_50_views' | 'flyer_clip_status' | 'broadcast_message' | 'keyword_in_about' | 'story_100_views' | 'snap_repost' | 'story_highlight' | 'channel_post' | 'group_message' | 'channel_join' | 'group_join';
