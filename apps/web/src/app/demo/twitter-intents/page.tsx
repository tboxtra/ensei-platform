            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-gray-800 rounded-lg p-6 mt-8">
                    ...
                    <div className="space-y-4 text-gray-300">
                        <div>
                            <h3 className="font-medium text-white mb-2">1. Intent URL Generation</h3>
                            <p>Our system generates Twitter intent URLs that open Twitter with specific actions ready to perform.</p>
                        </div>

                        <div>
                            <h3 className="font-medium text-white mb-2">2. User Experience</h3>
                        ...
                        <div>
                            <h3 className="font-medium text-white mb-2">4. Future API Integration</h3>
